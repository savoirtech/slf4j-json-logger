...
public class TraceLoggerTest {
  ...
  public void setupTest() throws Exception {
    ...
    this.logger = new TraceLogger(slf4jLogger, null, null) {
      @Override
  ...
  public void testLogException() throws Exception {
    ...
    Mockito.doThrow(rtExc).when(this.slf4jLogger).trace(this.testMessage);

    this.logger.log();

    Mockito.verify(slf4jLogger).trace("{\"" + rtExc + "\"}");
  }
