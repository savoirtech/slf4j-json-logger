...
/**
 * Log message body formatter that produces a JSON formatted body.
 *
 * Created by art on 7/19/17.
 */
public class JsonLogMessageBodyFormatter implements LogMessageBodyFormatter {
  private final Gson gson;

  public JsonLogMessageBodyFormatter(Gson gson) {
    this.gson = gson;
  }
