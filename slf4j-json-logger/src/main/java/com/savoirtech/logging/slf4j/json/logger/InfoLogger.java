...
public class InfoLogger extends AbstractJsonLogger {
  ...
  public InfoLogger(org.slf4j.Logger slf4jLogger, FastDateFormat formatter, Gson gson, boolean includeLoggerName, boolean includeThreadName, boolean includeClassName) {
